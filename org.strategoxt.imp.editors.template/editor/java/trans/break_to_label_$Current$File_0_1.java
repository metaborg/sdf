...
{ 
  ...
  @Override public IStrategoTerm invoke(Context context, IStrategoTerm term, IStrategoTerm c_33016)
  { 
    context.push("break_to_label_CurrentFile_0_1");
    Fail2006:
    { 
      IStrategoTerm e_33016 = null;
      e_33016 = term;
      term = dr_break_0_2.instance.invoke(context, e_33016, trans.const273, c_33016);
      if(term == null)
        break Fail2006;
