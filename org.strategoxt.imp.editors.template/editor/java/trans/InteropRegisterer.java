...
{ 
  ...
  { 
    ...
    varScope.addSVar("generate_sdf_0_0", new InteropSDefT(generate_sdf_0_0.instance, context));
  ...
  { 
    ...
    varScope.addSVar("generate_sdf_0_0", new InteropSDefT(classLoader, "trans.generate_sdf_0_0", context));
